...
/>
        ...
        >
          <div className='text-center ml-18'>
            <h2 className="text-orange-500 text-[12px] md:text-[27px] text-center font-semibold mt-[10px] ">Fan Regulations</h2>
...
export default FanRegulationsBanner